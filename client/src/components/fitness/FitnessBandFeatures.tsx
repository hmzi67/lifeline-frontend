    ...
    const features = [
        {
            ...
            title: "Counts Your Every Step",
            description: "Helps you stay active, motivated, and reach your daily goals with ease.."
        },
        {
            ...
            title: "Tracks Your Heart Rate",
            description: "Monitors your heartbeat in real time and keeps your heart health in check for a stronger, fitter you."
        },
        {
            ...
            title: "Tracks Your Sleep",
            description: "Helps you to improves your rest so you wake up refreshed and energized."
        }
    ];
