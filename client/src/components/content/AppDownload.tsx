...
export const AppDownload = ({ isLandingPage = false }) => {
    ...
    >
      ...
      />
                        ...
                        <a
                            href="#"
                            className="bg-black backdrop-blur-sm hover:bg-black/80 rounded-xl px-6 py-3 flex items-center justify-center space-x-3 cursor-pointer transition-all duration-300 shadow-lg border border-white/10"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="white">
