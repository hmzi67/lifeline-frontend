                ...
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
                    ...
                    <div className="text-white space-y-6 md:space-y-8 lg:pr-8 order-2 lg:order-1">
                        ...
                        <div className="flex justify-center gap-3 md:gap-4">
                            ...
                            <a
                                href="#"
                                className="bg-black rounded-xl px-4 md:px-6 py-3 flex items-center space-x-3 cursor-pointer hover:bg-gray-800 transition-all duration-200 shadow-lg flex-shrink-0"
                            >
