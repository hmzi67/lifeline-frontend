...
export const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    <div 
      ...
      className={`
        relative p-6 rounded-2xl border-2 transition-all duration-300 hover:shadow-lg cursor-pointer flex flex-col h-full
        ${isSelected
    ...
    >
      <div className="text-center mb-6">
        <h3 className={`text-lg font-semibold mb-4 ${isSelected ? 'text-white' : 'text-gray-800'}`}>
          {title}
        </h3>

        <div className="mb-2">
          <span className="text-4xl font-bold">${finalPrice}</span>
          <span className={`text-lg ${isSelected ? 'text-white' : 'text-gray-600'}`}>/m</span>
        </div>

        <div className={`text-sm mb-4 ${isSelected ? 'text-white' : 'text-gray-500'}`}>
          <span className="line-through">{originalPrice}</span>
        </div>

        <p className={`text-sm mb-4 ${isSelected ? 'text-white' : 'text-gray-600'}`}>
          ...
          <div className="mb-4">
            <button
              ...
              className={`
                ...
                ${isSelected ? 'text-white hover:text-gray-200' : 'text-primary hover:text-primary-600'}
              `}
            >
