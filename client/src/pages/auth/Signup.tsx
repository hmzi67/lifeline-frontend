...
const Signup: React.FC = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      setFieldErrors({ general: 'Signup failed. Please try again.' });
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl text-white hover:bg-white/10 transition-all duration-200 group"
              >
