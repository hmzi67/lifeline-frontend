                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                    ...
                    <div className="text-white space-y-8 lg:pr-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <a
                                href="#"
                                className="bg-black rounded-xl px-6 py-3 flex items-center space-x-3 cursor-pointer hover:bg-gray-800 transition-all duration-200 shadow-lg"
                            >
                    ...
                    {/* Right Section */}
                    <div className="hidden lg:block absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/4 overflow-visible z-0">
                        <div className="relative w-[500px] max-w-none">
                            {/* Background Image */}
                            <img
                                src={AppBgImage}
