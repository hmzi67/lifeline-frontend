    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl w-full">
                        ...
                        <div
                            ...
                            className={`relative flex-1 bg-white rounded-3xl p-8 cursor-pointer transition-all duration-300 transform hover:scale-105 ${
                                selectedGender === option.id
                                    ? 'ring-4 ring-teal-400 shadow-2xl'
                ...
                {selectedGender && (
                    <div className="text-center">
                        <button className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-16 py-5 rounded-full font-semibold text-xl hover:from-teal-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            Continue
                        </button>
                    </div>
                )}
