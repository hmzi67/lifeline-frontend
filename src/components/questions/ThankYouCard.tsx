  ...
  return (
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div
            ...
            style={{ backgroundImage: `url(${currentConfig.backgroundImage})` }}
        >
          <div
              className="absolute inset-0 transition-all duration-1000 ease-in-out"
              style={{ background: currentConfig.gradientOverlay }}
          />
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center">
          ...
          {isLoading ? (
              ...
              <button
                  onClick={onComplete}
                  className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-3 rounded-full font-semibold text-lg shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Continue
              </button>
          )}
